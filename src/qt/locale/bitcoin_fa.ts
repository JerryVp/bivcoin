...
Note:  Since the fee is calculated on a per-byte basis, a fee of "100 yamatonas per kB" for a transaction size of 500 bytes (half of 1 kB) would ultimately yield a fee of only 50 yamatonas.</source>
 ...
 توجه: از آنجا که کارمزد به ازای هر بایت محاسبه می شود ، هزینه "100 یاماتون در هر کیلوبایت" برای اندازه معامله 500 بایت (نیمی از 1 کیلوبایت) در نهایت کارمزد فقط 50 یاماتونا را به همراه خواهد داشت.</translation>
    </message>
    <message>
