...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1609639200, 3154610120, 0x1d00ffff, 1, 3000000 * COIN); // 03/01/2021 11:00:00 JP Times
        ...
        vSeeds.emplace_back("seed.bitcoin-value.io"); // Pieter Wuille, only supports x1, x5, x9, and xd
        // vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        // vSeeds.emplace_back("dnsseed.bitcoin.dashjr.org"); // Luke Dashjr
        // vSeeds.emplace_back("seed.bitcoinstats.com"); // Christian Decker, supports x1 - xf
        // vSeeds.emplace_back("seed.bitcoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        // vSeeds.emplace_back("seed.biv.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
...
public:
    CTestNetParams() {
        ...
        // vSeeds.emplace_back("seed.tbiv.petertodd.org");
