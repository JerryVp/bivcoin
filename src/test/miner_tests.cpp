...
void MinerTestingSetup::TestPackageSelection(const CChainParams& chainparams, const CScript& scriptPubKey, const std::vector<CTransactionRef>& txFirst)
{
    ...
    tx.vout[0].nValue = 5000000000LL - 1000 - 50000; // 50k yamatona fee
    ...
    tx.vout[1].nValue = 100000000; // 1BIV output
    ...
    tx.vout[0].nValue = 100000000 - 10000; // 10k yamatona fee
...
BOOST_AUTO_TEST_CASE(CreateNewBlock_validity)
{
    ...
    CScript scriptPubKey = CScript() << ParseHex("042221cbf6d3178693a41ac3fb72c390d44598577576b0955568007b6273e0861a11998cf67fc5f24f7795f45d68283b186990c45e368cdcc55aa7f48c887c2188") << OP_CHECKSIG;
