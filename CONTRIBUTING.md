Contributing to Bivcoin Core
============================

The Bivcoin Core project operates an open contributor model where anyone is
...
Most communication about Bivcoin Core development happens on IRC, in the
#bivcoin-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/bitcoin-value-dev/](http://www.erisian.com.au/bitcoin-value-dev/)
and [http://gnusha.org/bitcoin-value-dev/](http://gnusha.org/bitcoin-value-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/bitcoin-value-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to bivcoin-qt
...
The following applies to code changes to the Bivcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Bivcoin
Network Protocol consensus changes.

Whether a pull request is merged into Bivcoin Core rests with the project merge
...
Patches that change Bivcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bivcoin consensus, it must have been
...
The project leader is the release manager for each Bivcoin Core release.
