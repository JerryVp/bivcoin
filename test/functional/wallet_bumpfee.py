...
# Fee rates (in BIV per 1000 vbytes)
...
class BumpFeeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 BIV (100,000 yamatonas)
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # Bump with fee_rate of 0.00350250 BIV per 1000 vbytes to create dust.
    # Expected fee is 141 vbytes * fee_rate 0.00350250 BIV / 1000 vbytes = 0.00049385 BIV.
    # or occasionally 140 vbytes * fee_rate 0.00350250 BIV / 1000 vbytes = 0.00049035 BIV.
    # Dust should be dropped to the fee, so actual bump fee is 0.00050000 BIV.
...
def test_maxtxfee_fails(self, rbf_node, dest_address):
    ...
    # expected bump fee of 141 vbytes * 0.00200000 BIV / 1000 vbytes = 0.00002820 BIV
