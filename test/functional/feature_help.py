...
"""Verify that starting bivcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bivcoin with -h for help text")
        ...
        self.log.info("Start bivcoin with -version for version information")
        ...
        self.log.info("Start bivcoind with -fakearg to make sure it does not start")
