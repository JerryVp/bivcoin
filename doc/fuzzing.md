# Fuzzing Bivcoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Bivcoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/bitcoin-value/bivcoin/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/bitcoin-value/bivcoin/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/bitcoin-value/bivcoin/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/bitcoin-value/bivcoin/tree/master/src/test/fuzz).
...
Every single pull request submitted against the Bivcoin Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Bivcoin Core more robust.
...
with certain assembly code from Bivcoin Core's code. See [developer notes on sanitizers](https://github.com/bitcoin-value/bivcoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Bivcoin Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Bivcoin Core using [`afl-fuzz`](https://github.com/google/afl):
