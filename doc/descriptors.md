# Support for Output Descriptors in Bivcoin Core

Since Bivcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `biv1...` for mainnet or `tbiv1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Bivcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Bivcoin Core wallets, a convenience function `combo` is
...
All RPCs in Bivcoin Core will include the checksum in their output. Only
